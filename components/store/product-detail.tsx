...
export function ProductDetail({ product }: { product: Product }) {
  ...
  const addToCart = () => {
    for (let index = 0; index < quantity; index += 1) addItem(product, { size, color, variantId: selectedVariant?.id });
    setAdded(true);
